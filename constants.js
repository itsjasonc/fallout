...
export const perkData = {
    ...
    AGILITY: [
        ...
        { name: "Guerrilla", desc: "Special terrain also counts as cover and your attacks ignore obstructions." },
    ...
    ENDURANCE: [
        ...
        { name: "Chromomancer", desc: "Gain the ability to harvest mutant DNA to create a mutant ally." },
    ...
    INTELLIGENCE: [
        ...
        { name: "Overclock", desc: "Energy damage aimed shots cause the target to burn." },
...
export const backgroundData = [
    ...
    { name: "Exterminator", desc: "You can execute enemies with 3 or less HP." },
...
export const zoneTable = {
    ...
    31: "Casino: Contains a slot machine. Spend 40c to roll 1d6×10c. can luck/resist. Crit = 120c jackpot, 1 = break.",
